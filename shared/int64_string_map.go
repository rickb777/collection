...
// options: Comparable:true Stringer:true KeyList:collection.Int64List ValueList:collection.StringList Mutable:always
...
func (mm *Int64StringMap) mkString4Bytes(before, between, after, equals string) *strings.Builder {
	b := &strings.Builder{}
...
func (ts Int64StringTuples) mkString4Bytes(before, between, after, equals string) *strings.Builder {
	b := &strings.Builder{}
	sep := before
	for _, t := range ts {
		b.WriteString(sep)
